export default function HomePage() {
	return (
		<main id="homePage" className="h-[80vh] min-h-[50rem] sm:max-h-[41rem] relative">
			<div className="overflow-hidden relative mx-auto max-w-6xl flex justify-center flex-col p-6 text-center sm:text-left items-center sm:items-start h-full gap-[34px] pt-[17rem] sm:pt-0">
